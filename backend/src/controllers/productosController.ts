...
public async buscarProductoPaginado(req: Request, res: Response): Promise<void> {
    ...
    pool.query(`call bsp_buscar_producto_paginado('${req.params.IdPersona}','${pParametroBusqueda}','${desde}')`, function(err: any, result: any){
...
public async buscarProductoAutoComplete(req: Request, res: Response): Promise<void> {
    ...
    pool.query(`call bsp_buscar_producto_autocomplete('${pParametroBusqueda}','${pIdUsuario}')`, function(err: any, result: any){
